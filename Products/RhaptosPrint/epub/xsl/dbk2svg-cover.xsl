...
<flowRoot id="flowRoot2894" style="writing-mode:lr;text-anchor:start;text-align:start;" line-height="150%" font-weight="bold" xml:space="preserve" font-size="55.99999848px" transform="translate(-4.090618e-6,0)" font-stretch="normal" font-variant="normal" font-style="normal" font-family="Bitstream Vera Sans" fill="#ffffff"><flowRegion id="flowRegion2896"><rect id="rect2898" style="text-align:start;" height="575.88" width="515.26" y="97.885" x="40.412" fill="#FFF"/></flowRegion><flowPara id="flowPara2900"><xsl:value-of select="$title"/></flowPara></flowRoot></svg>
